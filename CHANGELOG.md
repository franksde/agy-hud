...
- Cached quota is merged with the payload per window, weekly included: a reading whose window has reset yields, and of two live readings the lower remainder is the newer one.
