...
- Cached quota is merged with the payload per window, weekly included: a later `reset_time` is a newer window, and within a window the lower remainder is the newer reading.
